...
using LibTads.Models.TokenAuth;
...
{
    public abstract class LibTadsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibTadsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibTadsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibTadsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibTadsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibTadsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibTadsDbContext, Task<T>> func)
        {
            T result;
